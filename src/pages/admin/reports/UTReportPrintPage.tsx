...
const PRINT_STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .sign-table td { border: 1px solid #d9e1ea; padding: 3px 5px; font-size: 12px; vertical-align: top; }
  ...
  .calib-table td, .calib-table th { border: 1px solid #d9e1ea; padding: 4px; font-size: 12px; text-align: center; vertical-align: middle; }
