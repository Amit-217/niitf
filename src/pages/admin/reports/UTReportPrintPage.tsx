...
const v = (s?: string | number) => (s !== undefined && s !== null ? String(s) : '');
        ...
        <div style={{ width: '210mm', minHeight: '297mm', background: '#fff', margin: '0 auto', padding: '5mm', boxShadow: '0 4px 24px rgba(0,0,0,0.12)' }}>
            ...
            <tbody>
              <tr>
                ...
                <td rowSpan={2} style={{ width: '20%', verticalAlign: 'middle', fontSize: '7.5pt', lineHeight: 1.6 }}>
                  <div><strong>Format No:</strong> FMT-NDT-UT-01</div>
          ...
          <table className="report-table mt-n1">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="val" style={{ color: '#c00', fontWeight: 600 }}>{v(eq.srNo)}</td>
              </tr>
              <tr>
                <td className="lbl">Make</td>
                <td className="val">{v(eq.make)}</td>
                <td className="lbl">Calibration Due</td>
                <td className="val" style={{ color: '#c00', fontWeight: 600 }}>{v(eq.calibrationDue)}</td>
              </tr>
              <tr>
          ...
          <table className="report-table mt-n1">
            <tbody>
              ...
              <tr>
                <td className="col-hdr" style={{ width: '20%' }}>Model</td>
                <td className="col-hdr" style={{ width: '12%' }}>Angle</td>
                <td className="col-hdr" style={{ width: '18%' }}>Sr. No.</td>
                <td className="col-hdr" style={{ width: '20%' }}>Crystal Size</td>
                <td className="col-hdr" style={{ width: '16%' }}>Wave Mode</td>
                <td className="col-hdr" style={{ width: '14%' }}>Frequency</td>
              </tr>
              {units.length === 0 ? (
                <tr><td colSpan={6} style={{ textAlign: 'center', padding: '4px', color: '#999', fontSize: '7.5pt' }}>No search units recorded.</td></tr>
              ) : units.map((u, i) => (
                <tr key={i}>
                  <td style={{ color: '#c00', fontWeight: 600, textAlign: 'center' }}>{v(u.model)}</td>
                  <td style={{ textAlign: 'center' }}>{v(u.angle)}</td>
                  <td style={{ color: '#c00', fontWeight: 600, textAlign: 'center' }}>{v(u.srNo)}</td>
          ...
          <table className="report-table mt-n1">
            ...
            <tbody>
              <tr><td colSpan={4} className="section-hdr">TECHNIQUE DETAILS</td></tr>
              <tr>
              ...
              <tr>
                ...
                <td className="val" style={{ color: '#c00', fontWeight: 600 }}>{v(td.scanningDb)}</td>
              </tr>
              <tr>
                <td className="lbl">Scanning Sensitivity</td>
                <td className="val" colSpan={3}>{v(td.scanningSensitivity)}</td>
              </tr>
            </tbody>
          </table>
          ...
          <table className="calib-table mt-n1">
            <tbody>
              <tr><td colSpan={5} className="section-hdr">ANGLE PROBE CALIBRATION DETAIL</td></tr>
              <tr>
                <td className="col-hdr" style={{ width: '20%' }}>Range / Point</td>
                {calibAngles.map(a => (
                  <td key={a.label} className="col-hdr">{a.label}</td>
                ))}
              </tr>
              {([
                ...
                <tr key={row.key}>
                  <td className="lbl" style={{ textAlign: 'left', paddingLeft: 4 }}>{row.label}</td>
                  {calibAngles.map(a => (
                    <td key={a.label} style={{ color: '#c00', fontWeight: 600 }}>
