...
export const UTGReportFormPage: React.FC = () => {
  ...
  const getFieldValue = (key: string): string => {
    const map: Record<string, string> = {
      ...
      jobSurfaceCondition:
        jobSurfaceCondition === "Other"
          ? jobSurfaceConditionOther
          : jobSurfaceCondition,
      jobExtent: jobExtent === "Other" ? jobExtentOther : jobExtent,
      jobSurfaceTemp:
        jobSurfaceTemp === "Other" ? jobSurfaceTempOther : jobSurfaceTemp,
  ...
  const handleSubmit = async (status: "draft" | "final") => {
    ...
    if (status === "final") {
      ...
      if (oth(jobSurfaceCondition, jobSurfaceConditionOther))
        e.jobSurfaceCondition = true;
      ...
      searchUnits.forEach((u, i) => {
        ...
        if (
          !(
            u.crystalSize &&
            (u.crystalSize !== "Other" || u.crystalSizeOther.trim())
          )
        )
          e[`searchUnit${i}_crystalSize`] = true;
        if (!u.waveMode) e[`searchUnit${i}_waveMode`] = true;
        if (
          !(u.frequency && (u.frequency !== "Other" || u.frequencyOther.trim()))
        )
                ...
                <tr key={idx} className="hover:bg-gray-50">
                  <td className="border border-gray-200 px-1 py-1">
                    <input
                      ...
                      className={
                        !!errors[`searchUnit${idx}_searchUnit`] &&
                        !u.searchUnit.trim()
                          ? inputErrorClass
                          : inputClass
                      }
                  ...
                  <td className="border border-gray-200 px-1 py-1">
                    <select
                      ...
                      className={
                        !!errors[`searchUnit${idx}_angle`] && !u.angle
                          ? inputErrorClass
                          : inputClass
                      }
                    >
                  ...
                  <td className="border border-gray-200 px-1 py-1">
                    <input
                      ...
                      className={
                        !!errors[`searchUnit${idx}_srNo`] && !u.srNo.trim()
                          ? inputErrorClass
                          : inputClass
                      }
                    />
                  ...
                  <td className="border border-gray-200 px-1 py-1 min-w-[140px]">
                    <SelectWithOther
                      ...
                      error={
                        !!errors[`searchUnit${idx}_crystalSize`] &&
                        !(
                          u.crystalSize &&
                          (u.crystalSize !== "Other" ||
                            u.crystalSizeOther.trim())
                        )
                      }
                    />
                  </td>
                  <td className="border border-gray-200 px-1 py-1">
                    <select
                      ...
                      className={
                        !!errors[`searchUnit${idx}_waveMode`] && !u.waveMode
                          ? inputErrorClass
                          : inputClass
                      }
                    >
                  ...
                  <td className="border border-gray-200 px-1 py-1 min-w-[130px]">
                    <SelectWithOther
                      ...
                      error={
                        !!errors[`searchUnit${idx}_frequency`] &&
                        !(
                          u.frequency &&
                          (u.frequency !== "Other" || u.frequencyOther.trim())
                        )
                      }
                    />
                  </td>
                ...
                <tr key={idx} className="hover:bg-gray-50">
                  ...
                  <td className="border border-gray-200 px-1 py-1">
                    <input
                      ...
                      className={
                        !!errors[`obs${idx}_itemName`] && !row.itemName?.trim()
                          ? inputErrorClass
                          : inputClass
                      }
                  ...
                  <td className="border border-gray-200 px-1 py-1">
                    <input
                      ...
                      className={
                        !!errors[`obs${idx}_measuredThickness`] &&
                        !row.measuredThickness?.trim()
                          ? inputErrorClass
                          : inputClass
                      }
            ...
            <div className="space-y-2">
              ...
              <div>
                ...
                <input
                  ...
                  className={
                    errors.custDesig && !custDesig.trim()
                      ? inputErrorClass
                      : inputClass
                  }
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={
                    errors.custDate && !custDate ? inputErrorClass : inputClass
                  }
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div>
                ...
                <input
                  ...
                  className={
                    errors.clientDesig && !clientDesig.trim()
                      ? inputErrorClass
                      : inputClass
                  }
                />
