...
const PRINT_STYLES = `
  ...
  @media print {
    ...
    #report-root > div {
      ...
      margin: 0 !important; padding: 5mm 8mm 45mm 8mm !important;
    ...
    .report { 
      ...
      width: 100% !important; 
      zoom: 0.89;
      transform: scale(0.89); transform-origin: top center;
    }
  ...
  * { box-sizing: border-box; }
  ...
  .obs-table td, .obs-table th { border: 1px solid #d9e1ea; padding: 3px 5px; font-size: 10px; vertical-align: middle; text-align: center; word-break: break-word; }
  .obs-table th { background: #E6F1FB; color: #0C447C; font-weight: 700; }
  .cert-para { font-size: 10px; font-style: italic; color: #333; padding: 4px 8px; border: 1px solid #d9e1ea; margin-top: -1px; line-height: 1.4; break-inside: avoid; }
