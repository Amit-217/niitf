...
export const AWSDReportPrintPage: React.FC = () => {
  ...
  if (!report) return <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100vh", gap: 12 }}><p>Report not found.</p><button onClick={goBack} style={{ padding: "8px 16px" }}>Go Back</button></div>;
