...
const emptyObs = (lineNo: number): ObsRow => ({
  lineNo,
  indicationNo: '', transducerAngle: '', transducerAngleOther: '',
  fromFace: '', leg: '',
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900">Report of UT of Welds (AWS D1.1)</h1>
      ...
      <div className={sectionClass}>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" value={reportNo} onChange={e => setReportNo(e.target.value)} className={inputClass} placeholder="e.g. NIIT/JF/UT/25-26/01" />
          </div>
          <div>
            <label className={labelClass}>Project</label>
            <input type="text" value={project} onChange={e => setProject(e.target.value)} className={inputClass} placeholder="e.g. Structural Bridge Fabrication" />
          </div>
        </div>
      </div>
      ...
      <div className={sectionClass}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" value={weldIdentification} onChange={e => setWeldIdentification(e.target.value)} className={inputClass} placeholder="e.g. W-01 to W-10" />
          </div>
          <div>
            <label className={labelClass}>Material Thickness</label>
            <input type="text" value={materialThickness} onChange={e => setMaterialThickness(e.target.value)} className={inputClass} placeholder="e.g. 20 mm" />
          </div>
          <div>
            <label className={labelClass}>Weld Joint AWS</label>
            <input type="text" value={weldJointAWS} onChange={e => setWeldJointAWS(e.target.value)} className={inputClass} placeholder="e.g. B-U2-GF" />
          </div>
          <div>
            <label className={labelClass}>Welding Process</label>
            <SelectWithOther
              value={weldingProcess} onChange={setWeldingProcess}
              otherValue={weldingProcessOther} onOtherChange={setWeldingProcessOther}
          ...
          <table className="w-full text-xs border-collapse min-w-[1400px]">
            <thead>
              <tr className="bg-gray-50 text-gray-600 uppercase">
                <th rowSpan={2} className="border border-gray-200 px-2 py-2 text-center w-10">Line No.</th>
                <th rowSpan={2} className="border border-gray-200 px-2 py-2 text-center">Indication No.</th>
                <th rowSpan={2} className="border border-gray-200 px-2 py-2 text-left">Transducer Angle</th>
                <th rowSpan={2} className="border border-gray-200 px-2 py-2 text-center">From Face</th>
              ...
              <tr className="bg-gray-50 text-gray-600">
                <th className="border border-gray-200 px-2 py-1 text-center bg-indigo-50">a. Indication Level</th>
                <th className="border border-gray-200 px-2 py-1 text-center bg-indigo-50">b. Reference Level</th>
                <th className="border border-gray-200 px-2 py-1 text-center bg-indigo-50">c. Attenuation Factor</th>
                <th className="border border-gray-200 px-2 py-1 text-center bg-indigo-50">d. Indication Rating</th>
                <th className="border border-gray-200 px-2 py-1 text-center bg-orange-50">Length</th>
                <th className="border border-gray-200 px-2 py-1 text-center bg-orange-50">Angular Distance</th>
                <th className="border border-gray-200 px-2 py-1 text-center bg-orange-50">Depth from &apos;A&apos; Surface</th>
                <th className="border border-gray-200 px-2 py-1 text-center bg-orange-50">From X</th>
                <th className="border border-gray-200 px-2 py-1 text-center bg-orange-50">From Y</th>
              </tr>
            </thead>
            <tbody>
              {observations.map((row, idx) => (
                <tr key={idx} className="hover:bg-gray-50">
                  <td className="border border-gray-200 px-2 py-1 text-center text-gray-500">{row.lineNo}</td>
                  <td className="border border-gray-200 px-1 py-1">
                    <input type="text" value={row.indicationNo} onChange={e => updateObs(idx, 'indicationNo', e.target.value)} className={inputClass} />
                  </td>
                  ...
                  <td className="border border-gray-200 px-1 py-1 bg-indigo-50/30">
                    <input type="text" value={row.dbIndicationLevel} onChange={e => updateObs(idx, 'dbIndicationLevel', e.target.value)} className={inputClass} placeholder="dB" />
                  </td>
                  <td className="border border-gray-200 px-1 py-1 bg-indigo-50/30">
                    <input type="text" value={row.dbReferenceLevel} onChange={e => updateObs(idx, 'dbReferenceLevel', e.target.value)} className={inputClass} placeholder="dB" />
                  </td>
                  <td className="border border-gray-200 px-1 py-1 bg-indigo-50/30">
                    <input type="text" value={row.dbAttenuationFactor} onChange={e => updateObs(idx, 'dbAttenuationFactor', e.target.value)} className={inputClass} placeholder="dB" />
                  </td>
                  <td className="border border-gray-200 px-1 py-1 bg-indigo-50/30">
                    <input type="text" value={row.dbIndicationRating} onChange={e => updateObs(idx, 'dbIndicationRating', e.target.value)} className={inputClass} placeholder="dB" />
                  </td>
                  <td className="border border-gray-200 px-1 py-1 bg-orange-50/30">
                    <input type="text" value={row.length} onChange={e => updateObs(idx, 'length', e.target.value)} className={inputClass} />
                  </td>
                  <td className="border border-gray-200 px-1 py-1 bg-orange-50/30">
                    <input type="text" value={row.angularDistance} onChange={e => updateObs(idx, 'angularDistance', e.target.value)} className={inputClass} />
                  </td>
                  <td className="border border-gray-200 px-1 py-1 bg-orange-50/30">
                    <input type="text" value={row.depthFromA} onChange={e => updateObs(idx, 'depthFromA', e.target.value)} className={inputClass} />
                  </td>
                  <td className="border border-gray-200 px-1 py-1 bg-orange-50/30">
                    <input type="text" value={row.distanceFromX} onChange={e => updateObs(idx, 'distanceFromX', e.target.value)} className={inputClass} />
                  </td>
                  <td className="border border-gray-200 px-1 py-1 bg-orange-50/30">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <input type="text" value={inspectedBy} onChange={e => setInspectedBy(e.target.value)} className={inputClass} placeholder="e.g. Mr. Mayur Bankar" />
            </div>
          </div>
          {/* Right */}
          <div className="space-y-3">
            <div>
              ...
              <input type="text" value={manufacturerOrContractor} onChange={e => setManufacturerOrContractor(e.target.value)} className={inputClass} placeholder="e.g. M/s XYZ Fabricators" />
            </div>
            <div>
