...
export const SalarySlipPage = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <button
            onClick={() => navigate(-1)}
            className="px-4 py-2 bg-primary-600 text-white rounded-xl font-bold text-sm"
          >
            Go Back
          </button>
        </div>
  ...
  const downloadSalarySlip = () => {
    ...
    const cardStyle = S(
      "background:#fff;border:1px solid #f1f5f9;border-radius:16px;padding:28px;margin-bottom:20px;",
    );
...
<body>
    ...
    <div style="${cardStyle}">
        ...
        <div style="display:flex;gap:12px;">
            ...
            <div style="flex:1;background:#ffffff;border:1px solid #ddd6fe;border-radius:12px;padding:14px;">
                <p style="font-size:9px;font-weight:900;text-transform:uppercase;letter-spacing:0.1em;color:#8b5cf6;">Cutoff</p>
                <p style="font-size:26px;font-weight:900;color:#5b21b6;margin-top:6px;">${summary.cutoffDays || 0}</p>
            </div>
        </div>
        <div style="background:#ecfdf5;border:1px solid #d1fae5;border-radius:10px;padding:10px 14px;font-size:11px;font-weight:700;color:#065f46;margin-top:14px;">
            ...
            Earnings include ${summary.payableDays} payable days (Present + Leaves + Holidays + Cutoff).
      ...
      <div className="max-w-2xl mx-auto py-8 px-4 space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          ...
          <p className="text-sm text-gray-500 mt-1">
            {record.employeeId?.empId || "N/A"} · {monthLabel}
          </p>
        ...
        {/* Attendance */}
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <h4 className="text-sm font-black text-emerald-900 uppercase tracking-[0.2em]">
            Attendance Overview
          </h4>
          <div className="mt-4 grid grid-cols-2 sm:grid-cols-6 gap-3">
            ...
            <div className="rounded-xl bg-white border border-amber-100 p-3">
              <p className="text-[10px] uppercase text-amber-500 font-black tracking-widest">
                Leave
              </p>
            ...
            <div className="rounded-xl bg-white border border-rose-100 p-3">
              <p className="text-[10px] uppercase text-rose-500 font-black tracking-widest">
                Absent
              </p>
            ...
            <div className="rounded-xl bg-white border border-sky-100 p-3">
              <p className="text-[10px] uppercase text-sky-500 font-black tracking-widest">
                Holiday
              </p>
            ...
            <div className="rounded-xl bg-white border border-purple-100 p-3">
              <p className="text-[10px] uppercase text-purple-500 font-black tracking-widest">
                Cutoff
              </p>
          ...
          <div className="flex items-start gap-2 text-[10px] text-emerald-800 mt-4 font-bold bg-emerald-100/50 p-2.5 rounded-xl border border-emerald-100">
            ...
            <p>
              Calculation Factor: {summary.daysInMonth} Days Month. Earnings
              include {summary.payableDays} payable days (Present + Leaves +
              Holidays + Cutoff). Overtime is calculated at a fixed 30-day rate
          ...
          <div className="mt-4 space-y-3 text-sm">
            ...
            <div className="flex justify-between gap-4">
              <span className="text-gray-500">
                Overtime ({record.overtimeUnits || 0} units)
              </span>
              <span className="font-bold text-emerald-600">
            ...
            <div className="flex justify-between gap-4">
              <span className="text-gray-500">
                Absent deduction ({record.absentDays || 0} days)
              </span>
        ...
        {record.note && (
          <div className="rounded-2xl border border-blue-100 bg-blue-50 p-5">
            <h4 className="text-xs font-black text-blue-800 uppercase tracking-[0.2em]">
              Note
            </h4>
