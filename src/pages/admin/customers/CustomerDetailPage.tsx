...
export const CustomerDetailPage = () => {
  ...
  const [editTarget, setEditTarget] = useState<Quotation | Invoice | null>(
    null,
  );
            ...
            >
                  ...
                  <>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="col-span-2">
                        ...
                        <input
                          ...
                          placeholder="e.g. NDT Services for XYZ Project"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          value={quoForm.date}
                          onChange={(e) =>
                            setQuoForm((f) => ({ ...f, date: e.target.value }))
                          }
                          className={inputClass}
                        />
                      </div>
                    ...
                    <div className="flex justify-end">
                      <TotalsBlock
                        ...
                        taxPercent={quoForm.taxPercent}
                        onDiscountChange={(v) =>
                          setQuoForm((f) => ({ ...f, discount: v }))
                        }
                        onTaxChange={(v) =>
                          setQuoForm((f) => ({ ...f, taxPercent: v }))
                        }
                      />
                    </div>
                    <div>
                      ...
                      <textarea
                        value={quoForm.notes}
                        onChange={(e) =>
                          setQuoForm((f) => ({ ...f, notes: e.target.value }))
                        }
                  ...
                  <>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="col-span-2">
                        ...
                        <input
                          ...
                          className={inputClass}
                          placeholder="e.g. Invoice for NDT Services"
                        />
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <select
                          value={invForm.paymentMode || ""}
                          onChange={(e) =>
                            setInvForm((f) => ({
                              ...f,
                              paymentMode: e.target
                                .value as Invoice["paymentMode"],
                            }))
                          }
                          className={inputClass}
                        >
                          <option value="">— Select —</option>
                          {["Cash", "UPI", "Bank Transfer", "Cheque"].map(
                            (m) => (
                    ...
                    <div className="flex justify-end">
                      <TotalsBlock
                        ...
                        taxPercent={invForm.taxPercent}
                        onDiscountChange={(v) =>
                          setInvForm((f) => ({ ...f, discount: v }))
                        }
                        onTaxChange={(v) =>
                          setInvForm((f) => ({ ...f, taxPercent: v }))
                        }
                      />
                    </div>
                    <div>
              ...
              <div className="p-5 bg-gray-50 border-t border-gray-100 flex gap-3">
                <button
                  type="button"
                  onClick={() => setModalOpen(false)}
                  className="flex-1 py-2.5 border border-gray-200 text-gray-600 rounded-xl text-sm font-bold hover:bg-white transition-all"
                >
                  Discard
                </button>
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex-[2] py-2.5 px-4 bg-gradient-to-r from-violet-600 to-indigo-600 text-white rounded-xl text-sm font-bold shadow-lg shadow-violet-100 hover:from-violet-700 hover:to-indigo-700 transition-all flex items-center justify-center gap-2 disabled:opacity-70"
                >
                  {submitting ? (
                    <Loader2 className="animate-spin" size={17} />
                  ) : (
                    <>
                      <Save size={17} /> {editTarget ? "Update" : "Save"}
                    </>
                  )}
                </button>
              </div>
